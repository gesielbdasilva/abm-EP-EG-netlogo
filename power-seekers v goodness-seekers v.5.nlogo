...
to setup
  ...
  set truth-freq-h1 avg-prior-h1-goodness-seekers
  let n-h1 round (truth-freq-h1 * total-ticks)
  let n-h2 (total-ticks - n-h1)
  set truth-schedule shuffle (sentence n-values n-h1 ["h1"] n-values n-h2 ["h2"])
...
to go
  ...
  ifelse ticks < total-ticks [set current-truth item ticks truth-schedule] [stop] ;stopping condition
  tick
end
...
<experiments>
  <experiment name="experiment" repetitions="20" runMetricsEveryStep="true">
    ...
    <metric>mean [prop-h1] of power-seekers</metric>
    <metric>mean [prop-h1] of goodness-seekers</metric>
    <metric>standard-deviation [prop-h1] of power-seekers</metric>
    <metric>standard-deviation [prop-h1] of goodness-seekers</metric>
    <metric>mean [truth-alignment] of power-seekers</metric>
    <metric>mean [truth-alignment] of goodness-seekers</metric>
  ...
  <experiment name="Paper Data Experiment" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>ticks = 100</exitCondition>
    <metric>mean [prop-h1] of power-seekers</metric>
  ...
  <experiment name="Run 7 (with small likelihoods)" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>ticks = 100</exitCondition>
    <metric>mean [prop-h1] of power-seekers</metric>
    <metric>mean [prop-h1] of goodness-seekers</metric>
    <metric>variance [prop-h1] of power-seekers</metric>
    <metric>variance [prop-h2] of goodness-seekers</metric>
    <metric>standard-deviation [prop-h1] of power-seekers</metric>
    <metric>standard-deviation [prop-h1] of goodness-seekers</metric>
    <metric>mean [truth-alignment] of power-seekers</metric>
    <metric>mean [truth-alignment] of goodness-seekers</metric>
  ...
  <experiment name="Paper Data Experiment (copy)" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>ticks = 100</exitCondition>
    <metric>mean [prop-h1] of power-seekers</metric>
  ...
  <experiment name="Paper Data Experiment (from Apr 2025)" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>ticks = 100</exitCondition>
    <metric>mean [prop-h1] of power-seekers</metric>
  ...
  <experiment name="Paper Data Experiment (from Apr 2025 v3)" repetitions="100" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>ticks = 100</exitCondition>
    <metric>mean [prop-h1] of power-seekers</metric>
  ...
  <experiment name="Paper Data Experiment (Jul 2025)" repetitions="100" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>ticks = 100</exitCondition>
    <metric>mean [prop-h1] of power-seekers</metric>
    ...
    <metric>prop-truth-ps</metric>
    <metric>prop-truth-gs</metric>
    <enumeratedValueSet variable="sd-priors-ps">
      <value value="0.25"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="sd-priors-gs">
  ...
  <experiment name="Paper Data Experiment prop_h1 (Jul 2025)" repetitions="100" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>ticks = 100</exitCondition>
    <metric>truth-likelihood</metric>
